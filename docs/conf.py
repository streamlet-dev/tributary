...
# -*- coding: utf-8 -*-
#
# tributary documentation build configuration file, created by
...
# built documents.
#
_version_py = os.path.join('..', 'tributary', '_version.py')
version_ns = {}
...
def run_apidoc(_):
    ...
    psp_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tributary'))
