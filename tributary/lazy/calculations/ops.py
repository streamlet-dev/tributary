...
def Sum(self, *others):
    ...
    return n_nary(
        ...
        + self._name_no_id()
        + ","
        + ",".join(other._name_no_id() for other in others_nodes)
        + ")",
        (
...
def Len(self):
    return unary(
        self, "len(" + str(self._name_no_id()) + ")", (lambda x: len(self.value()))
    )
