...
class TestConfig:
    ...
    def test_grid(self):
        with patch('tributary._depr.hosts.comm.get_ipython') as m, \
             patch('time.sleep') as m2, \
             patch('tributary._depr.hosts.comm.queue_get_all') as m3:
            ...
            from tributary._depr.hosts.comm import CommHandler
